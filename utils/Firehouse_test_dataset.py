...
class Firehouse_VOC_test_dataset(data.Dataset):
...
#         self.name = dataset_name
        self._annopath = osp.join(DATA_ROOT, 'test_annotations/', '%s.xml')
        
        self.annopath_dir = osp.join(DATA_ROOT, 'test_annotations/')
        self.labeled_dir = osp.join(DATA_ROOT, 'test_labeled_img/')
...
#                 self.ids.append((rootpath, line.strip()))
    ...
    def pull_item(self, index):
        img_id = img_id = self.labeled_ids[index]
