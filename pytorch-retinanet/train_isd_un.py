...
#                 if classification_loss:
        ...
        if epoch_num % 40 ==0:
            torch.save(retinanet.module, '{}_retinanet_isd_un2_L_{}.pt'.format(parser.dataset, epoch_num))

    retinanet.eval()

    torch.save(retinanet, 'model_final_isd_un2_L.pt')
