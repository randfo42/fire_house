...
def _evaluate(model, dataloader, class_names, img_size, iou_thres, conf_thres, nms_thres, verbose):
    ...
    for imgs, targets,_ in tqdm.tqdm(dataloader, desc="Validating"):
        # Extract labels
...
def run():
    ...
    parser.add_argument("-w", "--weights", type=str, default="./weights/yolotest.pth", help="Path to weights or checkpoint file (.weights or .pth)")
